      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <Button type="submit" className="w-full bg-[#FD5E2B] hover:bg-[#e04d1f] text-white" isLoading={isSubmitting}>
              Sign In
            </Button>
          </form>
          ...
          <div className="mt-6 text-center">
            <p className="text-[#404857]">
              ...
              <Link href="/register" className="text-[#FD5E2B] hover:underline font-medium">
                Create Account
              </Link>
            </p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <p className="text-sm text-[#404857] text-center">
