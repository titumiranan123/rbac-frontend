...
import { User, Permission, PaginatedResult } from '@/types';
...
export default function PermissionsPage() {
  ...
  const canGrantPermission = (level: number): boolean => {
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
          ...
          />
          <div className="space-y-2 max-h-screen-sm overflow-y-auto">
                        ...
                        return (
                          ...
                          >
                            <input
                              ...
                              disabled={!canToggle}
                              className="w-5 h-5 rounded border-gray-300 text-orange-500 focus:ring-orange-500 disabled:cursor-not-allowed"
                            />
