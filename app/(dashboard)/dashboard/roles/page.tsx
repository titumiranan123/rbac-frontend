        ...
        {roleData.map((role) => (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span
                className={`px-3 py-1 rounded-full text-xs font-medium ${role.level === 0 ? "bg-red-100 text-red-700" : role.level === 1 ? "bg-yellow-100 text-yellow-700" : "bg-blue-100 text-blue-700"}`}
              >
                Level {role.level}
              </span>
            </div>
